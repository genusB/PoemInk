...
namespace PoemInk.Controllers
{
    ...
    public class ExternalAuthController : Controller
    {
        ...
        public ExternalAuthController(IOptions<FacebookAuthSettings> fbAuthSettingsAccessor, UserManager<AppUser> userManager, PoemInkDbContext appDbContext, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
        {
